...
Trình đọc và chỉnh sửa PDF mã nguồn mở, local-first. **v1.3.2 có bản tải về cho cả ba nền tảng** — macOS (đã ký và notarize), Linux (AppImage) và Windows (gói portable). Xem [Tải xuống](#tải-xuống--v132) kèm checksum. Bản Windows vẫn còn ở mức portable zip chứ chưa phải bộ cài, và chưa được ký số.
...
Xem mục [Tải xuống](#tải-xuống--v132) cho file và checksum. Phần engine (MuPDF 1.28.0, OCRmyPDF, pyHanko) tự chứa và chạy được trong container
