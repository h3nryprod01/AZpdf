...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "AZpdf", dependencies: ["AZpdfCore"], path: ".", exclude: [".github", "README.md", "LICENSE", "CONTRIBUTING.md", "SECURITY.md", "CODE_OF_CONDUCT.md", "ROADMAP.md", "Assets", "Config", "Core", "Plugins", "docs", "script", ".codex", "dist", "Tests"], sources: ["App", "Models", "Services", "Stores", "Support", "Views"]),
